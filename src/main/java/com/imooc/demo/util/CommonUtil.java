...
import com.imooc.demo.config.exception.CommonJsonException;
import com.imooc.demo.util.constants.Constants;
import com.imooc.demo.util.constants.ErrorEnum;
...
public class CommonUtil {
    ...
    public static void fillOrgPk(final JSONObject paramObject){
        JSONObject object = (JSONObject) SecurityUtils.getSubject().getSession().getAttribute(Constants.SESSION_USER_PERMISSION);
        // admin可以查全部
